...
public class Parameters2IA extends Parameters{
	//Composant J2
	private JLabel labelStratJ2 = new JLabel("Strat�gie utilis�e ");
	...
	public Parameters2IA(JFrame p) {
		...
		stratJ2.addItem("Strat�gie 1");
		stratJ2.addItem("Strat�gie 2");
		
		//Position titre Joueur 1
		setPosition(0, getNiveauDispo(), 3);
		getPanel().add(new JLabel("Param�tre IA 2"), getConstraint());
		incrNiveauDispo();
		
		//Position du label de la liste d�roulante de strat�gie
		setPosition(0,getNiveauDispo(),1);
		getPanel().add(labelStratJ2, getConstraint());
		
		//Position de la liste d�roulante de strat�gie
